...
ElastixMain::Run()
{
  ...
  elastixBase.SetFixedMaskContainer(this->GetModifiableFixedWeightedMaskContainer());
  elastixBase.SetMovingMaskContainer(this->GetModifiableMovingWeightedMaskContainer());
