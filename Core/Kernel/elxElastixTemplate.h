...
public:
  ...
  /** Types for the weighted masks. */
  using FixedMaskPixelType = float;
  using MovingMaskPixelType = float;
  using FixedWeightedMaskType = itk::Image<FixedMaskPixelType, FixedDimension>;
